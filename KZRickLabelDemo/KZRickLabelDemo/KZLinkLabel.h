...
typedef NS_ENUM(NSInteger, KZLinkType) {
    ...
    KZLinkTypeHTMLHref          //HTML超链接 eg:<a href="http://www.baidu.com"></a>
};
...
typedef NS_OPTIONS(NSUInteger, KZLinkDetectionTypes) {
    ...
    KZLinkDetectionTypeHTMLHref    = (1 << 4),
...
@property (nonatomic, strong) NSAttributedString *KZAttributedString;
